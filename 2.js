...
<title> Demo Collegiate a Education category Flat Bootstrap Responsive Web Template</title>
...
<div id="topBar">
	...
	<div class="right">
		...
		<div class="go-back">
		 	<a href="/collegiate-education-category-flat-bootstrap-responsive-web-template/">Download Template</a>
		</div>
		<a id="close-button" title="Remove Frame" class="closeMe" href="https://p.w3layouts.com/demos/june-2016/13-06-2016/collegiate/web" target="_blank"></a>
	</div>
...
<div style="" id="device">
<iframe id="hw" class="web" src="https://p.w3layouts.com/demos/june-2016/13-06-2016/collegiate/web" name="livePreviewFrame" width="100%" height="100%" frameborder="0" noresize="noresize" style=" min-height: 100%;"> </iframe>
</div>
	<script>
